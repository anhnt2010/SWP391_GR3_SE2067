...
CREATE TABLE `attendances` (
  ...
  `method` enum('WIFI','DYNAMIC_QR') COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('VALID','INVALID','ADJUSTED') COLLATE utf8mb4_unicode_ci DEFAULT 'VALID',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `branches` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Mã chi nhánh',
...
INSERT INTO `branches` VALUES (1,'CN01','Chi nhánh Cầu Giấy','123 Xuân Thủy, Cầu Giấy, Hà Nội','ACTIVE',4,'2026-09-18 08:10:35');
...
CREATE TABLE `certificates` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Ví dụ: Chứng chỉ ATVSTP',
...
INSERT INTO `departments` VALUES (3,'Phòng An ninh & Bảo vệ'),(1,'Phòng Thu ngân'),(2,'Phòng Vận hành & Bán hàng');
...
INSERT INTO `employee_availabilities` VALUES (65,5,'MONDAY',1),(66,5,'TUESDAY',1),(67,5,'WEDNESDAY',1),(68,5,'THURSDAY',1),(69,5,'FRIDAY',1),(70,5,'SATURDAY',1),(71,5,'SUNDAY',1),(72,6,'MONDAY',3),(73,6,'TUESDAY',3),(74,6,'WEDNESDAY',3),(75,6,'THURSDAY',3),(76,6,'FRIDAY',3),(77,6,'SATURDAY',3),(78,6,'SUNDAY',3);
...
CREATE TABLE `employee_profiles` (
  ...
  `employee_type` enum('FULL_TIME','PART_TIME','SEASONAL') COLLATE utf8mb4_unicode_ci DEFAULT 'FULL_TIME',
  PRIMARY KEY (`user_id`),
...
INSERT INTO `employee_profiles` VALUES (4,'Nguyễn Văn Quản Lý','0987654321','001099000001',1,1,1,'FULL_TIME'),(5,'Trần Thị Nhân Viên','0912345678','001099000002',1,2,1,'PART_TIME'),(6,'Lê Văn Nhân Viên 2','0981112223','001099000003',1,2,1,'PART_TIME');
...
CREATE TABLE `employee_transfers` (
  ...
  `transfer_type` enum('PERMANENT','TEMPORARY') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Cố định hoặc Mượn tạm thời',
  `start_date` date NOT NULL,
  `end_date` date DEFAULT NULL,
...
INSERT INTO `open_shift_applications` VALUES (1,1,5,'REJECTED','2026-09-20 20:43:07'),(2,2,5,'APPROVED','2026-09-20 20:44:03'),(3,2,6,'REJECTED','2026-09-20 14:28:48'),(4,4,5,'APPROVED','2026-09-20 21:10:45'),(5,5,5,'APPROVED','2026-09-20 21:10:46'),(6,6,5,'REJECTED','2026-09-20 21:10:48'),(7,3,5,'REJECTED','2026-09-20 14:28:46'),(8,7,5,'APPROVED','2026-09-20 21:20:35'),(9,8,5,'REJECTED','2026-09-20 14:28:44'),(10,9,5,'REJECTED','2026-09-20 14:28:42'),(11,10,5,'APPROVED','2026-09-20 14:28:50');
...
INSERT INTO `open_shifts` VALUES (1,1,1,'2026-09-21',1,'OPEN'),(2,1,2,'2026-09-21',1,'OPEN'),(3,1,3,'2026-09-21',3,'OPEN'),(4,1,1,'2026-09-21',0,'CLOSED'),(5,1,2,'2026-09-21',0,'CLOSED'),(6,1,3,'2026-09-21',1,'OPEN'),(7,1,1,'2026-09-22',0,'CLOSED'),(8,1,2,'2026-09-22',1,'OPEN'),(9,1,1,'2026-09-23',1,'OPEN'),(10,1,1,'2026-09-24',0,'CLOSED');
...
CREATE TABLE `permissions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Ví dụ: account:create, shift:approve',
...
INSERT INTO `positions` VALUES (1,'Thu ngân',1),(2,'Nhân viên bán hàng',2),(3,'Nhân viên kho',2),(4,'Bảo vệ',3);
...
CREATE TABLE `recruitment_proposals` (
  ...
  `employment_type` enum('FULL_TIME','PART_TIME') COLLATE utf8mb4_unicode_ci DEFAULT 'FULL_TIME',
...
INSERT INTO `recruitment_proposals` VALUES (1,1,4,'PART_TIME',2,'2026-09-26','cần','REJECTED',4,3,'mỡ đấy mà húp','2026-09-18 16:12:29','2026-09-18 16:47:13'),(2,1,2,'PART_TIME',1,'2026-09-19','do đông khách','APPROVED',4,3,'chấp nhận','2026-09-18 16:46:15','2026-09-18 16:46:59');
...
CREATE TABLE `roles` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ADMIN, DIRECTOR, HR_MANAGER, STORE_MANAGER, EMPLOYEE',
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
...
INSERT INTO `roles` VALUES (1,'SYSTEM_ADMIN','Quản trị hệ thống'),(2,'DIRECTOR','Giám đốc chuỗi'),(3,'HR_MANAGER','Quản lý nhân sự chuỗi'),(4,'STORE_MANAGER','Quản lý chi nhánh'),(5,'EMPLOYEE','Nhân viên vận hành');
...
INSERT INTO `shift_schedules` VALUES (15,1,5,1,'2026-09-27',1,'PUBLISHED'),(16,1,6,3,'2026-09-27',1,'PUBLISHED'),(17,1,5,2,'2026-09-21',NULL,'PUBLISHED'),(18,1,5,1,'2026-09-21',NULL,'PUBLISHED'),(19,1,5,2,'2026-09-21',NULL,'PUBLISHED'),(20,1,5,1,'2026-09-22',NULL,'PUBLISHED'),(21,1,5,1,'2026-09-24',NULL,'PUBLISHED');
...
CREATE TABLE `shifts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Ca Sáng, Ca Chiều, Ca Tối',
...
INSERT INTO `shifts` VALUES (1,'Ca Sáng','07:00:00','12:00:00'),(2,'Ca Chiều','12:00:00','17:00:00'),(3,'Ca Tối','17:00:00','22:00:00');
...
CREATE TABLE `users` (
  ...
  `role_id` int NOT NULL,
  `status` enum('ACTIVE','INACTIVE','EMERGENCY_LOCKED') COLLATE utf8mb4_unicode_ci DEFAULT 'ACTIVE',
...
INSERT INTO `users` VALUES (1,'NV001','123456','admin@supermarket.com',1,'ACTIVE',NULL,'2026-09-18 08:10:35','2026-09-18 09:51:45',0),(2,'NV002','123456','director@supermarket.com',2,'ACTIVE',NULL,'2026-09-18 08:10:35','2026-09-18 15:53:14',0),(3,'NV003','123456','hr@supermarket.com',3,'ACTIVE',NULL,'2026-09-18 08:10:35','2026-09-18 15:53:43',0),(4,'NV004','123456','manager1@supermarket.com',4,'ACTIVE',NULL,'2026-09-18 08:10:35','2026-09-18 13:45:27',0),(5,'NV005','123456','employee01@supermarket.com',5,'ACTIVE',NULL,'2026-09-18 08:10:35','2026-09-18 16:54:44',0),(6,'NV006','123456','employee02@supermarket.com',5,'ACTIVE',NULL,'2026-09-21 00:42:17','2026-09-21 00:43:42',0),(7,'NV007','123456','employee_branch2@supermarket.com',5,'ACTIVE',NULL,'2026-09-21 00:49:02','2026-09-21 00:49:02',1),(9,'NV008','123456','manager_branch2@supermarket.com',4,'ACTIVE',NULL,'2026-09-21 00:51:35','2026-09-21 00:51:35',1);
...
-- Dump completed on 2026-09-20 21:41:02
